...
TAxis *axis = h->GetXaxis();
  ...
  /*
  cout<<"-------------- h_integral -------------"<<endl;
  cout<<"xmin = "<<xmin<<endl;
  cout<<"xmax = "<<xmax<<endl;
  cout<<"bmin = "<<bmin<<endl;
  cout<<"bmax = "<<bmax<<endl;
  cout<<"intgeral = "<<integral<<endl;
  cout<<"GetBinContent(bmin) = "<<h->GetBinContent(bmin)<<endl;
  cout<<"axis->GetBinLowEdge(bmin)) = "<<axis->GetBinLowEdge(bmin)<<endl;
  cout<<"axis->GetBinWidth(bmin) = "<<axis->GetBinWidth(bmin)<<endl;
  cout<<"intgeral(bmin) - = "<<integral<<endl;
  cout<<"intgeral(bmax) - = "<<integral<<endl;
  */
...
/*
cout<<"+++++++++++++++ for loop signal strength +++++++++++++++++"<<endl;
cout<<"mu[mui] = "<<mu[mui]<<endl;
cout<<"(double)(s) = "<<(double)(s)<<endl;
